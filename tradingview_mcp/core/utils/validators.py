...
STOCK_EXCHANGES: Set[str] = {"egx", "bist", "nasdaq", "nyse", "bursa", "myx", "klse", "ace", "leap", "hkex", "hk", "hsi", "asx", "sse", "szse", "chn", "set", "mai", "thailand"}
...
EXCHANGE_SCREENER = {
    ...
    # Thailand Stock Market Support
    "set": "thailand",      # Stock Exchange of Thailand (ตลาดหลักทรัพย์แห่งประเทศไทย)
    "mai": "thailand",      # Market for Alternative Investment (ตลาด mai)
    "thailand": "thailand", # Thailand screener alias
}
